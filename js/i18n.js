...
const STRINGS = {
  es: {
    savedCheck:'Guardado ✓', saveZone:'Guardar zona', nearbyShort:'Cerca', logVisit:'Registrar visita', call:'Llamar', addToCalendar:'Calendario', edit:'Editar',
    ...
    chooseNavApp:'Elige la app de navegación.', rememberChoice:'Recordar mi elección', remindersTitle:'Recordatorios', remindersText:'Revisita usa el calendario de tu teléfono para avisarte. Al guardar una revisita con fecha, se abre el calendario para añadirla con una alarma.',
    ...
    zoneSaving:'Guardando zona… {done}/{total}', zoneSaved:'Zona guardada para usar sin conexión ({count} mosaicos).', zoneOffline:'Conéctate a internet para guardar la zona.', zoneFailed:'No se pudo guardar toda la zona. Inténtalo de nuevo con conexión.',
  ...
  en: {
    savedCheck:'Saved ✓', saveZone:'Save area', nearbyShort:'Nearby', logVisit:'Log visit', call:'Call', addToCalendar:'Calendar', edit:'Edit',
    ...
    chooseNavApp:'Choose your navigation app.', rememberChoice:'Remember my choice', remindersTitle:'Reminders', remindersText:'Revisita uses your phone calendar to remind you. When you save a dated return visit, the calendar opens so you can add it with an alarm.',
    ...
    zoneSaving:'Saving area… {done}/{total}', zoneSaved:'Area saved for offline use ({count} tiles).', zoneOffline:'Connect to the internet to save the area.', zoneFailed:'Could not save the whole area. Try again while online.',
