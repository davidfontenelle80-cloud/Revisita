...
const STRINGS = {
  es: {
    ...
    pushTestWait:'Espera un minuto antes de probar otra vez.', timeTooSoon:'Muy pronto para el aviso: sale 5 minutos antes y necesita al menos 10 minutos. Sugerimos {time}.', timePast:'Esa hora ya pasó. Para recibir aviso, elige al menos 10 minutos desde ahora. Sugerimos {time}.', useSuggestedTime:'Usar {time}',
    pushSetupOpen:'Configurar', pushSetupLater:'Ahora no', pushSetupGotIt:'Entendido', pushSetupCheck:'Comprobar de nuevo', pushSetupTurnOn:'Activar avisos',
    pushSetupAskTitle:'¿Activar avisos de revisitas?', pushSetupAskText:'Revisita puede avisarte 5 minutos antes de cada revisita con hora, aunque la app esté cerrada. Si el teléfono pregunta, toca «Permitir».',
    pushSetupHomeTitle:'Instala Revisita para recibir avisos', pushSetupHomeText:'El iPhone solo envía avisos a apps abiertas desde la pantalla de inicio.', pushSetupHomeStep1:'En Safari, toca el botón Compartir (el cuadro con la flecha hacia arriba).', pushSetupHomeStep2:'Elige «Añadir a pantalla de inicio» y toca «Añadir».', pushSetupHomeStep3:'Abre Revisita desde el nuevo icono y activa los avisos.', pushSetupHomeTip:'Las revisitas guardadas en Safari no pasan solas a la app instalada. Usa Más → Exportar copia aquí y luego impórtala en la app.',
    pushSetupDeniedTitle:'Las notificaciones están bloqueadas', pushSetupDeniedText:'Revisita no puede volver a pedir el permiso. Actívalo en los ajustes del teléfono:', pushSetupDeniedIos1:'Abre Ajustes → Notificaciones.', pushSetupDeniedIos2:'Busca Revisita y activa «Permitir notificaciones».', pushSetupDeniedAndroid1:'Mantén pulsado el icono de Revisita → Información de la app → Notificaciones.', pushSetupDeniedAndroid2:'Activa las notificaciones. (En Chrome: ⋮ → Configuración → Configuración de sitios → Notificaciones.)', pushSetupDeniedBack:'Vuelve a Revisita y toca «Comprobar de nuevo».',
    pushBannerAsk:'Activa los avisos para que Revisita te recuerde tus revisitas.', pushBannerHome:'Para recibir avisos, añade Revisita a la pantalla de inicio.', pushBannerDenied:'Las notificaciones están bloqueadas en este dispositivo.', pushBannerTitle:'Tus revisitas no tienen aviso',
  ...
  en: {
    ...
    savedCheck:'Saved ✓', saveZone:'Save area', nearbyShort:'Nearby', logVisit:'Log visit', call:'Call', addToCalendar:'Calendar', addToCalendarBtn:'Add to Calendar', setReminderBtn:'Set Reminder', needDateTimeForReminder:'Set a date and time to create the reminder.', reminderSet:'Reminder on. We’ll notify you 5 minutes before.', reminderTooSoon:'Too soon for the reminder: it goes out 5 minutes before the visit. Pick at least 10 minutes from now.', edit:'Edit',
    ...
    pushTestWait:'Wait a minute before testing again.', timeTooSoon:'Too soon for the alert: it goes out 5 minutes before and needs at least 10 minutes. We suggest {time}.', timePast:'That time has already passed. To get an alert, pick at least 10 minutes from now. We suggest {time}.', useSuggestedTime:'Use {time}',
    pushSetupOpen:'Set up', pushSetupLater:'Not now', pushSetupGotIt:'Got it', pushSetupCheck:'Check again', pushSetupTurnOn:'Turn on alerts',
    pushSetupAskTitle:'Turn on return-visit alerts?', pushSetupAskText:'Revisita can alert you 5 minutes before each timed return visit, even when the app is closed. If your phone asks, tap “Allow”.',
    pushSetupHomeTitle:'Install Revisita to get alerts', pushSetupHomeText:'iPhone only sends alerts to apps opened from the Home Screen.', pushSetupHomeStep1:'In Safari, tap the Share button (the box with the arrow pointing up).', pushSetupHomeStep2:'Choose “Add to Home Screen”, then tap “Add”.', pushSetupHomeStep3:'Open Revisita from the new icon and turn on alerts.', pushSetupHomeTip:'Visits saved in Safari do not move to the installed app on their own. Use More → Export backup here, then import it in the app.',
    pushSetupDeniedTitle:'Notifications are blocked', pushSetupDeniedText:'Revisita cannot ask for permission again. Turn it on in your phone settings:', pushSetupDeniedIos1:'Open Settings → Notifications.', pushSetupDeniedIos2:'Find Revisita and turn on “Allow Notifications”.', pushSetupDeniedAndroid1:'Long-press the Revisita icon → App info → Notifications.', pushSetupDeniedAndroid2:'Turn notifications on. (In Chrome: ⋮ → Settings → Site settings → Notifications.)', pushSetupDeniedBack:'Come back to Revisita and tap “Check again”.',
    pushBannerAsk:'Turn on alerts so Revisita can remind you of your visits.', pushBannerHome:'To get alerts, add Revisita to your Home Screen.', pushBannerDenied:'Notifications are blocked on this device.', pushBannerTitle:'Your visits have no alerts',
