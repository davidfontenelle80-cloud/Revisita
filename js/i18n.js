...
const STRINGS = {
  es: {
    ...
    coordinatesLabel:'Latitud, longitud', coordinatesHint:'Escribe latitud y longitud separadas por coma.', goCoordinates:'Ir a coordenadas', coordinatesInvalid:'Escribe coordenadas válidas, por ejemplo 18.7357, -70.1627.', coordinatesReady:'Mapa centrado. Toca la casa para colocar el pin.', showAllVisits:'Ver todas las visitas ({count})', showRecentVisits:'Ver solo las recientes',
  ...
  en: {
    ...
    coordinatesLabel:'Latitude, longitude', coordinatesHint:'Enter latitude and longitude separated by a comma.', goCoordinates:'Go to coordinates', coordinatesInvalid:'Enter valid coordinates, for example 18.7357, -70.1627.', coordinatesReady:'Map centered. Tap the house to place a pin.', showAllVisits:'Show all visits ({count})', showRecentVisits:'Show recent visits only',
