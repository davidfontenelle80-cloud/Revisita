...
const STRINGS = {
  es: {
    skip:'Ir al contenido', updateAvailable:'Hay una actualización disponible.', update:'Actualizar',
    ...
    locationFailed:'No se pudo obtener la ubicación.', locationNotSaved:'Esa ubicación todavía no está guardada. Confirma la ubicación primero.',
  ...
  en: {
    skip:'Skip to content', updateAvailable:'An update is available.', update:'Update',
    ...
    locationFailed:'Could not get your location.', locationNotSaved:'That location has not been saved yet. Confirm the location first.',
